...
# Aim    : Demonstrate the 'update_node_file' method of the Compound Discoverer Scripting Node "Helper" (CDScriptingNodeHelper) file. The method is defined in the CDScriptingNodeHelper and is used to update the node file. Returns the updated node file dictionary with the new options.
#==============================================================================
