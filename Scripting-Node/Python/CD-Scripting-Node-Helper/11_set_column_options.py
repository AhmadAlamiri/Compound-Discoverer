...
# Aim    : Demonstrate the 'set_column_options' method of the Compound Discoverer Scripting Node "Helper" (CDScriptingNodeHelper) file. The method is defined in the CDScriptingNodeHelper and is used to set the options for the specified column in the specified table in the node file. Returns the updated node file dictionary with the new options set for the specified column.
#==============================================================================
...
# Use the method 'set_column_options' to set the options for the column.
# Parameters
# ----------
# node_file : dict
#     The node file dictionary containing the tables.
...
response.set_column_options(node_response, 'New CD Table', 'New CD Column', Options={'Option1': 'Value1', 'Option2': 'Value2'})
