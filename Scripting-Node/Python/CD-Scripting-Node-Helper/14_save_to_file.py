...
# Aim    : Demonstrate the 'save_to_file' method of the Compound Discoverer Scripting Node "Helper" (CDScriptingNodeHelper) file. The method is defined in the CDScriptingNodeHelper and is used to save the node file to a file on disk. 
#==============================================================================
...
# Use the method 'update_node_file' to update the node file.
# Parameters
# ----------
# node_file : dict
#     The node file dictionary to set options for.
# **kwargs : dict, optional
...
response.update_node_file(node_response, CurrentWorkflowID = '999', Version = '2.0')


# Use the method 'save_to_file' to save the node file to a file on disk.
# Parameters
# ----------
# node_file : dict
