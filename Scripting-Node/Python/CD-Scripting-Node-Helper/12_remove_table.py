...
# Aim    : Demonstrate the 'remove_table' method of the Compound Discoverer Scripting Node "Helper" (CDScriptingNodeHelper) file. The method is defined in the CDScriptingNodeHelper and is used to remove the specified table from the node file. Returns the updated node file dictionary with the table removed.
#==============================================================================
...
# Use the method 'remove_table' to remove the table.
# Parameters
# ----------
# node_file : dict
...
response.remove_table(node_response, 'New CD Table')
